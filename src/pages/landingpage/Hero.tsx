  ...
  return (
    <div className='relative w-full h-[400px] lg:h-screen  '>
       ...
       <img src="https://res.cloudinary.com/dv4dlmp4e/image/upload/v1728504305/Untitled-1_yv8zfp.png" alt=""  className="h-[150px] w-[150px] object-contain text-black" />
        ...
        <Link to={"/signin"}>
           <button className="w-[80px] h-[45px] border rounded-md hover:bg-purple-600 hover:border-none cursor-pointer  ">Sign-in</button></Link>
           <Link to={"/signup"}>
           <button className="w-[80px] h-[45px] hover:border hover:bg-inherit rounded-md bg-purple-600 cursor-pointer " >Sign-up</button></Link>
        </div>
     ...
     {toggle? (
      <div className="flex bg-black w-full justify-end h-[400px] relative top-0  ">
        ...
        <div className=' w-full h-full opacity-70 bg-black flex flex-col justify-center items-center text-white p-6 '>
